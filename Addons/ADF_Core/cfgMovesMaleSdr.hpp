class CfgMovesMaleSdr: CfgMovesBasic
{
	class States
	{
		...
		{
			actions = DeadActions;
			file = "\ADF_Core\Anim\Driver_Boat_Civil_02_KIA.rtm";
			looped = false;
			terminal = true;
			soundEnabled = false;
		...
		{
			file = "\ADF_Core\Anim\Driver_Boat_Civil_02.rtm";
		...
		{
			actions = DeadActions;
			file = "\ADF_Core\Anim\Heli_Attack_03_pilot_KIA.rtm";
            speed = 0.5;
			looped = false;
			terminal = true;
			soundEnabled = false;
		...
		{
			file = "\ADF_Core\Anim\Heli_Attack_03_pilot.rtm";
		...
		{
			actions = DeadActions;
			file = "\ADF_Core\Anim\Heli_Attack_03_gunner_KIA.rtm";
            speed = 0.5;
			looped = false;
			terminal = true;
			soundEnabled = false;
		...
		{
			file = "\ADF_Core\Anim\Heli_Attack_03_gunner.rtm";
		...
		{
			actions = DeadActions;
			file = "\ADF_Core\Anim\Passenger_Plane_Transport_01_KIA.rtm";
			looped = false;
			terminal = true;
			soundEnabled = false;
			connectTo[] = {Unconscious,0.1};
		...
		{
			file = "\ADF_Core\Anim\Passenger_Plane_Transport_01.rtm";
		...
		{
			file = "\ADF_Core\Anim\pilot_Plane_Fighter_05_idle.rtm";
		...
		{
			file = "\ADF_Core\Anim\pilot_Plane_Fighter_05_get_in.rtm";
			speed = -6.2;
			looped = false;
			connectTo[] = {};
			interpolateTo[] =
		...
		{
			file = "\ADF_Core\Anim\pilot_Plane_Fighter_05_get_out.rtm";
			speed = -5;
		...
		{
			actions = DeadActions;
			file = "\ADF_Core\Anim\Pilot_Plane_Transport_01_KIA.rtm";
			looped = false;
			terminal = true;
			soundEnabled = false;
			connectTo[] = {Unconscious,0.1};
		...
		{
			file = "\ADF_Core\Anim\Pilot_Plane_Transport_01.rtm";
		...
		{
			file = "\ADF_Core\Anim\driver_APC_Wheeled_04_in.rtm";
			interpolateTo[] =
            {
		...
		{
			file = "\ADF_Core\Anim\driver_APC_Wheeled_04_out.rtm";
			interpolateTo[] =
            {
                KIA_Driver_APC_Wheeled_04,1,
		...
		{
			actions = DeadActions;
			file = "\ADF_Core\Anim\driver_APC_Wheeled_04_kia.rtm";
			looped = false;
			terminal = true;
			soundEnabled = false;
			connectTo[] = {Unconscious,0.1};
		...
		{
			file = "\ADF_Core\Anim\gunner_APC_Wheeled_04_in.rtm";
			interpolateTo[] =
            {
		...
		{
			file = "\ADF_Core\Anim\gunner_APC_Wheeled_04_out.rtm";
			interpolateTo[] =
            {
                KIA_Gunner_APC_Wheeled_04,1,
		...
		{
			actions = DeadActions;
			file = "\ADF_Core\Anim\gunner_APC_Wheeled_04_kia.rtm";
			looped = false;
			terminal = true;
			soundEnabled = false;
			connectTo[] = {Unconscious,0.1};
		...
		{
			file = "\ADF_Core\Anim\commander_APC_Wheeled_04_in.rtm";
			interpolateTo[] =
            {
		...
		{
			file = "\ADF_Core\Anim\commander_APC_Wheeled_04_out.rtm";
			interpolateTo[] =
            {
                KIA_Commander_APC_Wheeled_04,1,
		...
		{
			actions = DeadActions;
			file = "\ADF_Core\Anim\commander_APC_Wheeled_04_kia.rtm";
			looped = false;
			terminal = true;
			soundEnabled = false;
			connectTo[] = {Unconscious,0.1};
