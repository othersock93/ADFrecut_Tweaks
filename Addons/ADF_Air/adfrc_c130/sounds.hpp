	...
	soundGetIn[] = {"\ADF_Air\adfrc_c130\sounds\open",db-10,1};
	soundGetOut[] = {"\ADF_Air\adfrc_c130\sounds\close",db-10,1,40};
	...
	soundEngineOnInt[] = {"\ADF_Air\adfrc_c130\sounds\C192_engine_start_int",db-8,1.0};
	soundEngineOnExt[] = {"\ADF_Air\adfrc_c130\sounds\C192_engine_start_ext",db8,1,700};
	soundEngineOffInt[] = {"\ADF_Air\adfrc_c130\sounds\C192_engine_stop_int",db-8,1.0};
	soundEngineOffExt[] = {"\ADF_Air\adfrc_c130\sounds\C192_engine_stop_ext",db8,1,700};
	soundLocked[] = {"\A3\Sounds_F\weapons\Rockets\locked_1",db-10,1};
	soundIncommingMissile[] = {"\A3\Sounds_F\vehicles\air\noises\alarm_locked_by_missile_1",db-10,1.0};
	soundGearUp[] = {"\ADF_Air\adfrc_c130\sounds\gear_up",db-2,1,150};
	soundGearDown[] = {"\ADF_Air\adfrc_c130\sounds\gear_down",db-2,1,150};
	soundFlapsUp[] = {"\ADF_Air\adfrc_c130\sounds\flaps_up",db-4,1,100};
	soundFlapsDown[] = {"\ADF_Air\adfrc_c130\sounds\flaps_down",db-4,1,100};
	class scrubLandInt
	{
	...
	class Sounds
	{
		class EngineMidhExt
		{
			sound[] = {"\ADF_Air\adfrc_c130\sounds\C192_engine_mid_ext",db5,1,1100};
			frequency = 1;
			volume = 0.7 * machcone*camPos*(rpm factor[0.5, 1]);
		};
		class EngineHighExt
		{
			sound[] = {"\ADF_Air\adfrc_c130\sounds\C192_engine_high_ext",db5,1,1100};
			frequency = 1 min (rpm+0.5)*(rpm factor[0.5, 1.1]);
			volume = 0.7 * machcone*engineOn*camPos*(rpm factor[0, 1])*(thrust factor[0, 0.75]);
		};
		class ForsageExt
		{
			sound[] = {"\ADF_Air\adfrc_c130\sounds\C192_prop_ext",db3,1.2,1100};
			frequency = 1;
		...
		class EngineMidhInt
		{
			sound[] = {"\ADF_Air\adfrc_c130\sounds\C192_engine_mid_int",db-2,1,1100};
			frequency = 1 min (rpm+0.25)*(rpm factor[0, 1]);
			volume = 1 * engineOn*(1-camPos)*(rpm factor[0.5, 1]);
		};
		class EngineHighInt
		{
			sound[] = {"\ADF_Air\adfrc_c130\sounds\C192_engine_high_int",db-2,1,1100};
			frequency = 1 min (rpm+0.25)*(rpm factor[0.25, 1.1]);
			volume = 1 * engineOn*(1-camPos)*(rpm factor[0, 1]);
		};
		class ForsageInt
		{
			sound[] = {"\ADF_Air\adfrc_c130\sounds\C192_prop_int",db-7,1.2,1100};
