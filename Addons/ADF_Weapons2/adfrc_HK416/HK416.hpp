...
class ADFRC_HK416_556_115: ADFRC_HK416_556_Base
	{
		author = "Brucey";
		ACE_barrelTwist = 177.8;
		ACE_barrelLength = 294;
		recoil = "recoil_spar";
		...
		model = "adf_weapons2\adfrc_hk416\adfrc_Hk416";
		descriptionShort = "HK416 <br/>11.5in<br/>Caliber: 5.56";
		inertia = 0.225;
		scope=2;
		scopeWeapon=2;
		scopeArsenal = 2;
